...
const homeFunction = () => {
  ...
  p1.innerHTML =
    "Serving the community since 2017 in the four corners neighborhood of Dorchester.";
  boxContainer.appendChild(p1);

  let p2 = document.createElement("p");
  p2.classList.add("copy");
  p2.innerHTML =
    "The consciousness is expanded on health — health and wellness. It’s up to us to take care of our bodies, mind, and spirit. This is our focus: to help with the community and ourselves as well.";
  ...
  p3.innerHTML =
    "Come by and enjoy one of our fresh dishes or one of our juices, smoothies, or shakes. Visit our menu section to see our combo meals, wraps, and grain bowl choices.";
